...
// var cities = {
//     town: 'Cedar Rapids',
//     link: 'index.html?q=Cedar%20Rapids&APPID=eb5cff2c542e454a13fb9d52a2a5c3ca',
// }
...
function getCityName(event) {
    ...
    var searchQuery = 'index.html?q=' + cityName + '&APPID=' + apiKey;
    console.log(searchQuery);

    localStorage.setItem('newCityName', cityName);
    localStorage.setItem('newCityUrl', searchQuery);
...
var retrievedNewCityName = localStorage.getItem('newCityName');
var retrievedNewCityUrl = localStorage.getItem('newCityUrl');
console.log(retrievedNewCityName);
console.log(retrievedNewCityUrl);
